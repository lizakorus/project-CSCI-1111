...
int main(){
        ...
        while (!gameOver && timeLeft > 0) {
            switch(currentRoom) {
                case KINGS_CHAMBER: {
                    ...
                    scanf("%d", &choice);
                    if(choice == 0){
                        printf("You are unable to add item to inventory and cannot use it.\n");
                        printf("You remain in darkness and cannot continue.\n");
                        gameOver = 1;
                        break;
                    } else (choice == 1);
                        {
                        printf("You have a torch. You can use the lighter you carry to light it.\n");
                        printf("Light it? 1 = yes 0 = no \n");
                        scanf("%d", &choice);
    ...
    printf("Do you want to replay? yes = 1, no = 0\n");
